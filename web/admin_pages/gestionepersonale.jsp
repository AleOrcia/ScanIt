...
<body class="bg-white dark:bg-gray-900">
   <div class="container">
       <div class="left-column mt-4">
           ...
           <div class="mt-4">
               <button class="w-59 h-12 px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-md shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 dark:bg-blue-300 dark:hover:bg-blue-400 dark:focus:ring-offset-gray-700" id="gp" onclick="redirect(this)">Gestione Personale</button>
           </div>
           <div class="mt-4">
